...
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS ea_backup1 TEXT;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS ea_backup2 TEXT;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS ea_backup3 TEXT;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS ps_backup1 TEXT;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS ps_backup2 TEXT;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS ps_backup3 TEXT;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS rank_achieved TEXT;
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS rank_urgency TEXT CHECK (rank_urgency IN ('urgent', 'anytime'));
